    ...
    <div className="footer-container">
      <div className="footer-content">
        <div className="footer-section">
          <h3 className="footer-brand gold">Montgomery Construction</h3>
        ...
        <div className="footer-section">
          ...
          <a href="#projects" className="footer-link">Our Work</a>
          <a href="#contact" className="footer-link">Get Quote</a>
        </div>
      </div>
      ...
      <div className="footer-bottom">
        ...
        <div className="footer-credit">
          <p>Website by <a href="#" className="footer-credit-link">Pioneer Web Services</a></p>
        </div>
      </div>
    </div>
  );
